  ...
  computed: {
	 isRegister: {
		...
		set(val) {
		  ...
		  this.$store.dispatch('setisRegister',val) ;
		}
	 } 
  },
  methods: {
    ...
    Register() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        //如果通过校验开始注册
        if (valid) {
			let username = this.RegisterUser.name
			let password = this.RegisterUser.pass
			this.$store.dispatch('zhuche',{username,password})
          // this.$axios
